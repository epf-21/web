  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="relative w-48 h-64 cursor-pointer overflow-hidden" onClick={toggleDoor}>
        ...
        <div 
          className={`absolute w-44 h-60 bg-amber-700 border-2 border-amber-900 top-2 left-2 transition-transform duration-1000 ease-in-out ${
      ...
      <p className="mt-4 text-center text-gray-700 font-sans">
          {msg}
      </p>
    </div>
  );
